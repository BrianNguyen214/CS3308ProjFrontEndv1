    ...
    <body>
        ...
        <div class='eventSection'>
            <div class="eventSecHeaderGrid">
                ...
                <div class="eventSHGISeeMore">
                    <a href="#" v-if="musicEvents">View more</a>
                </div>
            </div>
        ...
        <div class='eventSection'>
            <div class="eventSecHeaderGrid">
                ...
                <div class="eventSHGISeeMore">
                    <a href="#" v-if="artAndPerfEvents">View more</a>
                </div>
            </div>
        ...
        <div class='eventSection'>
            <div class="eventSecHeaderGrid">
                ...
                <div class="eventSHGISeeMore">
                    <a href="#" v-if="healthAndFitEvents">View more</a>
                </div>
            </div>
        ...
        <div class='eventSection'>
            <div class="eventSecHeaderGrid">
                ...
                <div class="eventSHGISeeMore">
                    <a href="#" v-if="foodAndDrinkEvents">View more</a>
                </div>
            </div>
